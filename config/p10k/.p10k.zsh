# Generated by Powerlevel10k configuration wizard on 2020-11-12 at 18:10 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 49145.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean, 2 lines,
# disconnected, no frame, compact, many icons, concise, instant_prompt=off.
